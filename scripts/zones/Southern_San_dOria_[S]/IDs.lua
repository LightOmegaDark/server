...
zones[xi.zone.SOUTHERN_SAN_DORIA_S] =
{
    text =
    {
        ...
        GATHERED_DAWNDROPS_LIGHT      = 14537, -- The gathered dawndrops unleash a brilliant light, melding together to form <keyitem>!
        RETRACED_ALL_JUNCTIONS        = 14538, -- You have retraced all junctions of eventualities. Hasten back to where Cait Sith and Lilisette await.
